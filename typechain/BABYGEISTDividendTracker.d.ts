...
interface BABYGEISTDividendTrackerInterface extends ethers.utils.Interface {
  functions: {
...
export class BABYGEISTDividendTracker extends BaseContract {
  ...
  interface: BABYGEISTDividendTrackerInterface;
